...
export default function TicketGap({ rows, counts }: Props) {
    return (
        <AuthenticatedLayout title="Tickets manquants">
            <Head title="Tickets manquants (GPS vs TransportTracking)" />

            <div className="space-y-4">
                <div className="flex items-center gap-2">
                    <FileWarning size={22} className="text-red-500" />
                    <h1 className="text-xl font-semibold">Tickets manquants (réconciliation GPS)</h1>
                </div>
